...
<BlockImage src="hardware/electronics-guide/power.png" alt="power" width="80%" />
...
<BlockImage src="hardware/electronics-guide/communication.png" alt="communicaiton" width="80%" />
