...
If you run into issues while designing or mounting your end-effector, join our [Discord](https://discord.gg/tpnKxHuJY3) or post on our [forums](https://forums.example.com/robotic-arm) (put relevant link here).
